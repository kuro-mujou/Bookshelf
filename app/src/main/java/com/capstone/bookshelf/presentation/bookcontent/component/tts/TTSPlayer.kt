...
class TTSPlayer(
    ...
    private var state = State.Builder()
        ...
        .setPlayWhenReady(false, PLAY_WHEN_READY_CHANGE_REASON_SUPPRESSED_TOO_LONG)
        .setAudioAttributes(
    ...
    fun updatePlaybackState(playbackState: Int, playWhenReady: Boolean) {
        ...
        mainHandler.post {
            state = state.buildUpon()
                ...
                .setPlayWhenReady(playWhenReady, PLAY_WHEN_READY_CHANGE_REASON_SUPPRESSED_TOO_LONG)
                .build()
            invalidateState()
        }
    }
